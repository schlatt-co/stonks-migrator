...
public class Member extends Entity {
  ...
  public final tycho.stonks2.model.core.Role role;
  public final boolean acceptedInvite;

  public Member(int pk, UUID player, int companyPk, Timestamp joinTimestamp, tycho.stonks2.model.core.Role role, boolean acceptedInvite) {
    super(pk);
  ...
  public boolean canChangeRole(Member other, tycho.stonks2.model.core.Role newRole) {
  ...
  public Boolean hasManagamentPermission() {
    return role == tycho.stonks2.model.core.Role.CEO || role == Role.Manager;
  }
}
