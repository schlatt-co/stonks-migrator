...
public class Company extends Entity {
  ...
  public final Collection<tycho.stonks2.model.core.Member> members;

  public final Collection<tycho.stonks2.model.core.Account> accounts;


  public Company(int pk, String name, String shopName, String logoMaterial, Boolean verified, Boolean hidden,
                 Collection<tycho.stonks2.model.core.Account> accounts, Collection<tycho.stonks2.model.core.Member> members) {
    super(pk);
    this.name = name;
  ...
  public tycho.stonks2.model.core.Member getMember(Player player) {
    for (tycho.stonks2.model.core.Member member : members) {
